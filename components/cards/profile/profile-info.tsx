...
import { BriefcaseBusiness, GithubIcon, Mail, MapPin } from 'lucide-react'
...
export function ProfileCardInfo() {
  return (
    <div className="hidden py-4 md:block md:px-5">
      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">chienxx(Kanade)</h3>
      ...
      <div className="mb-2 mt-4 space-y-4">
        <div className="flex items-center text-gray-700 dark:text-gray-200">
          ...
          <p className="flex items-center px-2">Backend Developer</p>
        </div>
        <div className="flex items-center text-gray-700 dark:text-gray-200">
