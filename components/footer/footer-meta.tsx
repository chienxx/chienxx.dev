    ...
    <div className="space-y-2 py-1.5 text-gray-800 dark:text-gray-200">
      <div className="flex items-center gap-1 font-medium">
        ...
        <Link href={SITE_METADATA.siteRepo} className="ml-1">
          <GrowingUnderline className="plausible-event-name=view+repo">{repoName}</GrowingUnderline>
        </Link>
        <span>-</span>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-medium">
          [::1]:443 - Nanjing, <Twemoji emoji="flag-china" className="!h-4.5" />
        </span>
      </div>
      <div className="flex items-center gap-2">
        <Clock className="h-5 w-5" />
        <Link href={TIME_IS}>
          <GrowingUnderline className="plausible-event-name=footer+time font-medium">
